...
vector<Vehicle> Vehicle::lane_change_trajectory(string state, 
  ...
  if (vehicleahead_clearance < this->preferred_buffer - 5)
	  return trajectory;
...
double Vehicle::getVelocityChecked(double vel_to_reach,double current_velocity,double time_span,double next_step_velocity){
