...
void MapPath::get_map_XYspline_for_s(double s_val, double d_val,vector<double> &prev_pts_x, vector<double> &prev_pts_y, double ref_yaw){
	 ...
	 xy_curve.set_points(pts_x,pts_y,spline::cspline);
